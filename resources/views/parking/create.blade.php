...
@section('content')
    <div class="container">
        <h1 class="text-center mb-4">Добавяне на разходи за паркинг на камион {{$truck->licence_plate}}</h1>
        <div class="row p-2">
            <div class="col-md-6 ">
                <form method="post" action="{{route('parking.store')}}" class="">
                    @csrf
                ...
                <div class="parking_lots">
                    ...
                    @foreach($parking_lots as $parking)
                        <div class="border-bottom row">
                            ...
                            <span class="col-md-4 col-sm-3 col-2 d-inline-block">{{$parking->price}}</span>
                            <span class="col-md-4 col-sm-3 col-2 d-inline-block">{{$parking->note}}</span>
                        </div>
                    @endforeach
                </div>
